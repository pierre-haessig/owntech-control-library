...
equation
  ...
  Documentation(info = "<html><head></head><body><h1>Three phase cosine source perturbed with harmonics and high frequency noise</h1><div><img src='../../figures/png/CosinePerturbed3ph.png'></div><div><br></div></body></html>"));
