...
model CosinePerturbed3ph "Three-phase cosine source perturbed with harmonics and high frequency noise"
  ...
  parameter Real amplitude_a=1 "Amplitude of cosine wave, phase a";
  parameter Real amplitude_b=amplitude_a "Amplitude of cosine wave, phase b";
  parameter Real amplitude_c=amplitude_a "Amplitude of cosine wave, phase c";
  ...
  CosinePerturbed ya(amplitude = amplitude_a, final f = f, final phase = phase_a, offset = offset, final n_odd = n_odd, final amplitudes_odd_rel = amplitudes_odd_rel, final phases_odd = phases_odd, harmonics = harmonics, amplitude_hf_rel = amplitude_hf_rel, f_hf = f_hf)  annotation(
    Placement(transformation(origin = {-50, 50}, extent = {{-10, -10}, {10, 10}})));
  CosinePerturbed yb(amplitude = amplitude_b, amplitude_hf_rel = amplitude_hf_rel, final amplitudes_odd_rel = amplitudes_odd_rel, final f = f, f_hf = f_hf, harmonics = harmonics, final n_odd = n_odd, offset = offset, final phase = phase_b, final phases_odd = phases_odd) annotation(
    Placement(transformation(origin = {-50, 0}, extent = {{-10, -10}, {10, 10}})));
  CosinePerturbed yc(amplitude = amplitude_c, amplitude_hf_rel = amplitude_hf_rel, final amplitudes_odd_rel = amplitudes_odd_rel, final f = f, f_hf = f_hf, harmonics = harmonics, final n_odd = n_odd, offset = offset, final phase = phase_c, final phases_odd = phases_odd) annotation(
    Placement(transformation(origin = {-50, -50}, extent = {{-10, -10}, {10, 10}})));
